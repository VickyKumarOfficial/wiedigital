...
const implementationSteps = ['Map curriculum and batches', 'Set up LMS/KMS workspace', 'Deliver modules and track progress']
  ...
  return (
    <main>
      <section className="mx-auto grid w-[min(100%-1.5rem,76rem)] gap-10 py-20 md:grid-cols-[1fr_0.85fr] md:py-28">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-violet-200/65">For institutions</p>
          <h1 className="mt-4 text-balance text-5xl font-bold leading-tight text-white md:text-7xl">
            Run modern tech programs with platform-backed delivery.
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-400">
            Wielearn helps schools and centers organize curriculum, manage resources, and monitor learner progress across AI, CS, IT and IP programs.
          </p>
        ...
        <div className="rounded-[2rem] border border-white/[0.08] bg-white/[0.035] p-5">
          <div className="rounded-2xl border border-white/[0.06] bg-black/25 p-4">
            <p className="font-bold text-white">Institution workspace</p>
      ...
      <section className="mx-auto w-[min(100%-1.5rem,76rem)] py-12">
        <h2 className="text-3xl font-bold text-white md:text-4xl">Platform capabilities</h2>
      ...
      <section className="mx-auto w-[min(100%-1.5rem,76rem)] py-12 pb-24">
        <h2 className="text-3xl font-bold text-white md:text-4xl">Implementation flow</h2>
