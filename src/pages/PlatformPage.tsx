  ...
  return (
    <main>
      <section className="mx-auto w-[min(100%-1.5rem,76rem)] py-20 md:py-28">
        <p className="text-sm font-semibold uppercase tracking-[0.18em] text-violet-200/65">Platform</p>
        <h1 className="mt-4 max-w-4xl text-balance text-5xl font-bold leading-tight text-white md:text-7xl">
          A dashboard-heavy workspace for learning operations.
        </h1>
        <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-400">
          Manage LMS delivery, institutional knowledge, analytics and classroom workflows from a single product surface.
        </p>
      </section>
        ...
        <div className="min-h-96 rounded-[2rem] border border-white/[0.08] bg-[#0b0b0d] p-5">
          <div className="rounded-[1.5rem] border border-white/[0.06] bg-black/25 p-5">
            <div className="flex items-center justify-between">
              <p className="font-bold text-white">Operations overview</p>
              <span className="rounded-full bg-white/[0.06] px-3 py-1 text-xs text-zinc-400">LMS/KMS</span>
            </div>
